...
* There is a 95% chance that babies on average weigh 7.4 to 7.5 pounds. --> *correct*
</div>
...
* there is a 95% chance that their birth weight will be 5.4 to 9.5 pounds.-->*correct*
...
Exploratory data analysis for nc_premie
...
```{r}
dplyr::select(samples0, mu, y_pred0) %>%
  map(quantile, prob = c(0.025, 0.5, 0.975))
```
...
* Both distributions are approximately symmetric. -->*correct*
...
* there is a 95% chance that babies born to nonsmoker mothers are on average 0.11 to 0.54 pounds heavier at birth than babies born to smoker mothers. -->*correct*
</div>
