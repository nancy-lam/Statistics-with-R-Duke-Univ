...
<li> A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries. </li> -->*correct*
</ol>
...
<li> Telephone </li>
<li> Internet </li> 
<li> All of the above </li> -->*correct*
</ol>
...
<ol>
<li> Countries </li> 
<li> Individual Persons </li> -->*correct*
<li> Religions </li>
</ol>
...
<li> The margin of error for the estimate of the proportion of atheists in the US in 2012 is 0.0135. </li> -->*correct*
</ol>
...
inference(y = response, data = chi12, statistic = 'proportion', type = 'ci', method = 'theoretical', success = 'atheist')
...
inference(y = response, x = as.factor(year), data = spain, statistic = 'proportion', type = 'ht', null = 0, alternative = 'twosided', success = 'atheist', method = 'theoretical')
```
...
inference(y = response, x = as.factor(year), data = united, statistic = 'proportion', type = 'ht', null = 0, alternative = 'twosided', success = 'atheist', method = 'theoretical')
...
<li> 9604 people </li> 
<li> At least 9604 people </li> -->*correct*
</ol>
```{r sample-size}
p_maxME <- 0.5
me <- 0.01
