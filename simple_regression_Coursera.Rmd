...
<li> The relationship is positive, linear, and moderately strong. One of the potential outliers is a team with approximately 5520 at bats. </li> -->*correct*
...
<ol>
<li> For each additional home run, the model predicts 1.83 more runs, on average. </li> -->*correct*
...
```{r residual}
y_predict <- -2789.2429 + 0.6305 * 5579

residual <- 713 - y_predict
residual
...
<li> The residuals show a curved pattern. </li> -->*correct*
...
<ol>
<li> on-base plus slugging (`new_obs`) </li> -->*correct*
