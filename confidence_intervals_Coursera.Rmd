...
```{r ci}
samp %>%
  summarize(lower = mean(area) - z_star_95 * sd(area)/sqrt(n), upper = mean(area) + z_star_95 * sd(area)/sqrt(n))
```
...
<li> 95% of random samples of size 60 will yield confidence intervals that contain the true average area of houses in Ames, Iowa. </li> -->*correct*
