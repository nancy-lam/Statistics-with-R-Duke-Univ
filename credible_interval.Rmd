...
* The probability that the true proportion of females lies in this interval is 0.95. -->*correct*
...
* Gamma($\alpha = 8119$, $\beta = 5001$) -->*correct*
